...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', '02e72940-693e-4b84-99f4-11b63025fec5', 11, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', '02e72940-693e-4b84-99f4-11b63025fec5', 12, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', '02e72940-693e-4b84-99f4-11b63025fec5', 13, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', '02e72940-693e-4b84-99f4-11b63025fec5', 14, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', '02e72940-693e-4b84-99f4-11b63025fec5', 15, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (21, '02e72940-693e-4b84-99f4-11b63025fec5');

-- Seed reviews
INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
VALUES
  (21, '02e72940-693e-4b84-99f4-11b63025fec5', 5, 'Excellent developer tool!', NOW(), NOW()),
  (22, '02e72940-693e-4b84-99f4-11b63025fec5', 4, 'Great design features', NOW(), NOW()),
  (23, '02e72940-693e-4b84-99f4-11b63025fec5', 5, 'Amazing marketing automation', NOW(), NOW()),
  (24, '02e72940-693e-4b84-99f4-11b63025fec5', 4, 'Very helpful coding assistant', NOW(), NOW()),
  (25, '02e72940-693e-4b84-99f4-11b63025fec5', 5, 'Powerful visualization tool', NOW(), NOW());
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, '02e72940-693e-4b84-99f4-11b63025fec5', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, '02e72940-693e-4b84-99f4-11b63025fec5', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, '02e72940-693e-4b84-99f4-11b63025fec5', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, '02e72940-693e-4b84-99f4-11b63025fec5', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, '02e72940-693e-4b84-99f4-11b63025fec5', NOW(), NOW());

-- Seed post upvotes (bridge table)
INSERT INTO post_upvotes (post_id, profile_id)
VALUES (1, '02e72940-693e-4b84-99f4-11b63025fec5');

-- Seed post replies
INSERT INTO post_replies (post_id, profile_id, reply, created_at, updated_at)
VALUES
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, '02e72940-693e-4b84-99f4-11b63025fec5', 'These design tips are very helpful', NOW(), NOW()),
  (3, '02e72940-693e-4b84-99f4-11b63025fec5', 'Marketing automation is crucial', NOW(), NOW()),
  (4, '02e72940-693e-4b84-99f4-11b63025fec5', 'Launch strategy is on point', NOW(), NOW()),
  (5, '02e72940-693e-4b84-99f4-11b63025fec5', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, '02e72940-693e-4b84-99f4-11b63025fec5', NOW()),
...
VALUES (1, '02e72940-693e-4b84-99f4-11b63025fec5', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'Hello! Interested in collaboration', NOW()),
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'Let''s discuss the project details', NOW()),
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'What''s your availability?', NOW()),
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'I can start next week', NOW()),
  (1, '02e72940-693e-4b84-99f4-11b63025fec5', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('02e72940-693e-4b84-99f4-11b63025fec5', 21, NULL, '02e72940-693e-4b84-99f4-11b63025fec5', 'review', NOW()),
  ('02e72940-693e-4b84-99f4-11b63025fec5', NULL, 1, '02e72940-693e-4b84-99f4-11b63025fec5', 'reply', NOW()),
  ('02e72940-693e-4b84-99f4-11b63025fec5', NULL, NULL, '02e72940-693e-4b84-99f4-11b63025fec5', 'follow', NOW()),
  ('02e72940-693e-4b84-99f4-11b63025fec5', NULL, 2, '02e72940-693e-4b84-99f4-11b63025fec5', 'mention', NOW()),
  ('02e72940-693e-4b84-99f4-11b63025fec5', 22, NULL, '02e72940-693e-4b84-99f4-11b63025fec5', 'review', NOW());
