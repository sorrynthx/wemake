...
const searchParamsSchema = z.object({
  type: z
    ...
    .optional()
    .transform((val) => val as typeof JOB_TYPES[number]["value"] | undefined),
  location: z
    .enum(LOCATION_TYPES.map((type) => type.value) as [string, ...string[]])
    .optional()
    .transform((val) => val as typeof LOCATION_TYPES[number]["value"] | undefined),
  salary: z
    .enum(SALARY_RANGE)
    .optional()
    .transform((val) => val as typeof SALARY_RANGE[number] | undefined),
});
